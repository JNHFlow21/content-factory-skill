...
- 适合：热点类、观点类文章
- 风格：**戏剧性冲突、强烈对比、情绪爆发、电影感构图、第一眼锁住眼球**

**创意 B: 氛围渲染型**
- 策略：营造一种情绪或场景氛围，引发好奇
- 适合：故事类、情绪类文章
- 风格：**电影感光影、情绪张力、氛围感强、让人想点进去看**

**创意 C: 信息图表型**
- 策略：用简洁的图形/图标/数据可视化传递信息
- 适合：干货类、清单类、测评类文章
- 风格：**有视觉冲击力、不是干巴巴的图表、要让人想细看**
...
- **风格关键词要有爆发力和情绪张力**，具体写法参考：
  - **情绪型**：`cinematic, dramatic lighting, emotional tension, high contrast, bold composition, moody atmosphere`
  - **冲击型**：`explosive, impactful, high energy, dramatic contrast, visual punch, unsettling, powerful`
  - **氛围型**：`moody, cinematic, atmospheric, rich textures, film grain, warm tones, intimate lighting`
  - **图表型**：`bold graphic design, dynamic layout, punchy colors, editorial magazine style, eye-catching`
  - **避免**：不要用 `flat design, minimalist, tech aesthetic, clean, sterile, AI-generated look`（这些词容易出 AI 感）
...
- 文字区域：右侧留出干净空间
- AI 绘图提示词：
  "A large balance scale, left side stacked with red-themed microchips, right side with blue-themed microchips, scale tilting left, dark moody background with dramatic lighting, cinematic, high contrast, emotional tension, visual punch, bold composition, 16:9 aspect ratio, clean space on the right third for text overlay, no text no letters no words"
- 适配工具建议：即梦（国内场景理解好）
